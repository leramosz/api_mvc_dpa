<?
  ...
  $json = file_get_contents('https://apis.modernizacion.cl/dpa/comunas', false, $contexto);
  ...
  foreach ($input as $k => $v) {
	...
	$query = "INSERT INTO communes (id, type, name, latitude, longitude, url, province_id) VALUES (".$values.")";
	echo $query;
