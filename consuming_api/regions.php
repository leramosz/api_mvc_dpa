<?
  ...
  $json = file_get_contents('https://apis.modernizacion.cl/dpa/regiones', false, $contexto);
  ...
  foreach ($input as $k => $v) {
	...
	$query = "INSERT INTO regions (id, type, name, latitude, longitude, url, country_id) VALUES (".$values.")";
	echo $query;
